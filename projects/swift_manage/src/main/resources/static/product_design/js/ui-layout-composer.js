...
jQuery(document).ready(function($) {
    ...
    var fpd_ui_layout_composer_opts = {
        fpd_ui_layout_composer_opts: "The default layout can not be deleted!",
        overwrite_info: "The current selected layout will be overwritten!",
        delete_info: "Delete selected layout?",
        reset_default_info: "Are your sure to reset the current selected layout to default?",
        info_action_tooltip: "The text can be changed in the Labels settings!",
        general_plugin_opts: {
            templatesDirectory: "/assets/templates/"
		}
    }

	var initial_opts = $.getJSON ("/static/product_design/layout/default_ui_layout.json");
	if(!initial_opts) {
		return;
	}
